    ...
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
        <div class="absolute inset-0 z-0">
            ...
            <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt="Real estate agents analyzing lead data and analytics"
        ...
        <div class="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            ...
            <div class="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="p-6 bg-gray-50 rounded-xl border border-gray-200" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <p class="text-gray-600 text-sm mt-2">Successfully delivered leads for over 100 real estate
                        projects</p>
                </div>
                <div class="p-6 bg-gray-50 rounded-xl border border-gray-200" data-aos="fade-up" data-aos-delay="400">
                    <div class="text-3xl font-bold text-green-600 mb-2">Verified</div>
                    <div class="font-medium">Leads Only</div>
                    <p class="text-gray-600 text-sm mt-2">We filter and verify leads before they reach your sales team
                    </p>
                </div>
                <div class="p-6 bg-gray-50 rounded-xl border border-gray-200" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <p class="text-gray-600 text-sm mt-2">Industry-leading conversion rates from leads to clients</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="p-6 bg-gray-800 rounded-2xl shadow-lg card-hover border border-gray-700" data-aos="fade-up"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2 text-white">100% Real Estate Focus</h3>
                ...
                <div class="p-6 bg-gray-800 rounded-2xl shadow-lg card-hover border border-gray-700" data-aos="fade-up"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2 text-white">Multi-Channel Strategy</h3>
                            <p class="text-gray-300">
                ...
                <div class="p-6 bg-gray-800 rounded-2xl shadow-lg card-hover border border-gray-700" data-aos="fade-up"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2 text-white">Pre-Qualified Leads Only</h3>
                            <p class="text-gray-300">
                ...
                <div class="p-6 bg-gray-800 rounded-2xl shadow-lg card-hover border border-gray-700" data-aos="fade-up"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2 text-white">Conversion-Focused Landing Pages & Ads</h3>
                            <p class="text-gray-300">
                ...
                <div class="p-6 bg-gray-800 rounded-2xl shadow-lg card-hover border border-gray-700" data-aos="fade-up"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2 text-white">Integrated with CRM & WhatsApp Automation</h3>
                            <p class="text-gray-300">
                ...
                <div class="p-6 bg-gray-800 rounded-2xl shadow-lg card-hover border border-gray-700" data-aos="fade-up"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2 text-white">Transparent Performance Reports</h3>
                            <p class="text-gray-300">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover border border-gray-200"
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">780+ qualified leads in 45 days with 4.2% conversion rate through
                            targeted Meta and Google campaigns.</p>
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-green-600">Multi-Channel Campaign</span>
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover border border-gray-200"
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">450+ qualified leads in 30 days for a suburban development
                            using targeted ad funnels and WhatsApp automation.</p>
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-green-600">WhatsApp + Meta</span>
                            <a href="#" class="text-sm font-medium hover:text-green-800 transition-colors">View
                                Details →</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover border border-gray-200"
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">1,200+ engaged leads across email and SMS nurtures, improving
                            pipeline velocity and qualified appointments.</p>
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-green-600">CRM & Email Automation</span>
                            <a href="#" class="text-sm font-medium hover:text-green-800 transition-colors">View
                                Details →</a>
                        </div>
                    </div>

        ...
        <div class="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            ...
            <div class="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="p-6 bg-gray-50 rounded-xl border border-gray-200" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <p class="text-gray-600 text-sm mt-2">Buyers decide based on property visuals first</p>
                </div>
                <div class="p-6 bg-gray-50 rounded-xl border border-gray-200" data-aos="fade-up" data-aos-delay="400">
                    <div class="text-3xl font-bold text-green-600 mb-2">3x</div>
                    <div class="font-medium">More Engagement</div>
                    <p class="text-gray-600 text-sm mt-2">Quality visuals generate 3x more engagement</p>
                </div>
                <div class="p-6 bg-gray-50 rounded-xl border border-gray-200" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <p class="text-gray-600 text-sm mt-2">Properties with quality content sell faster</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="p-6 bg-gray-800 rounded-2xl shadow-lg card-hover border border-gray-700" data-aos="fade-up"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2 text-white">Real Estate–Specialized Creative Team</h3>
                ...
                <div class="p-6 bg-gray-800 rounded-2xl shadow-lg card-hover border border-gray-700" data-aos="fade-up"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2 text-white">High-End Visual Quality (Drone, 4K, 3D)</h3>
                            <p class="text-gray-300">
                ...
                <div class="p-6 bg-gray-800 rounded-2xl shadow-lg card-hover border border-gray-700" data-aos="fade-up"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2 text-white">Storytelling that Builds Buyer Emotion</h3>
                            <p class="text-gray-300">
                ...
                <div class="p-6 bg-gray-800 rounded-2xl shadow-lg card-hover border border-gray-700" data-aos="fade-up"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2 text-white">Quick Turnaround & Consistent Branding</h3>
                            <p class="text-gray-300">
                ...
                <div class="p-6 bg-gray-800 rounded-2xl shadow-lg card-hover border border-gray-700" data-aos="fade-up"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2 text-white">Seamless Integration with Marketing Strategy
                            </h3>
                            <p class="text-gray-300">
                ...
                <div class="p-6 bg-gray-800 rounded-2xl shadow-lg card-hover border border-gray-700" data-aos="fade-up"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2 text-white">Proven Track Record of Results</h3>
                            <p class="text-gray-300">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover border border-gray-200"
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">High-end photos + video ad = 5x more inquiries and faster sales
                            for luxury apartment project.</p>
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-green-600">Photography & Video</span>
                            <a href="#" class="text-sm font-medium hover:text-green-800 transition-colors">View Project
                                →</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover border border-gray-200"
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Drone tour video reached 120k+ views on YouTube, generating
                            high-quality international leads.</p>
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-green-600">Drone & Video Production</span>
                            <a href="#" class="text-sm font-medium hover:text-green-800 transition-colors">View Project
                                →</a>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover border border-gray-200"
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">3D walkthrough and virtual tour increased on-site visits by 40%
                            for commercial property launch.</p>
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-green-600">3D & Virtual Tours</span>
                            <a href="#" class="text-sm font-medium hover:text-green-800 transition-colors">View Project
                                →</a>
                        </div>
                    </div>
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center text-white">
            ...
            {{-- <div class="bg-white rounded-2xl shadow-2xl p-8 max-w-2xl mx-auto" data-aos="fade-up"
                ...
                <form class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-gray-700 text-sm font-medium mb-2 text-left">Your Name</label>
                            <input type="text"
                                class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-green-600 focus:ring-2 focus:ring-green-600/20 transition-all"
                                placeholder="John Doe">
                        </div>
                        <div>
                            <label class="block text-gray-700 text-sm font-medium mb-2 text-left">Email Address</label>
                            <input type="email"
                                class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-green-600 focus:ring-2 focus:ring-green-600/20 transition-all"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-gray-700 text-sm font-medium mb-2 text-left">Phone Number</label>
                            <input type="tel"
                                class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-green-600 focus:ring-2 focus:ring-green-600/20 transition-all"
                                placeholder="+1 (555) 000-0000">
                        </div>
                        <div>
                            <label class="block text-gray-700 text-sm font-medium mb-2 text-left">Company</label>
                            <input type="text"
                                class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-green-600 focus:ring-2 focus:ring-green-600/20 transition-all"
                    ...
                    <div>
                        <label class="block text-gray-700 text-sm font-medium mb-2 text-left">What creative services
                    ...
                    <div>
                        <label class="block text-gray-700 text-sm font-medium mb-2 text-left">Tell us about your
                            project</label>
                        <textarea rows="4"
                            class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-green-600 focus:ring-2 focus:ring-green-600/20 transition-all"

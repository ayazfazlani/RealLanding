            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="p-6 bg-white rounded-2xl shadow-lg card-hover border border-slate-100" data-aos="fade-up"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2">100% Focus on Real Estate SEO</h3>
                            <p class="text-slate-600">
                ...
                <div class="p-6 bg-white rounded-2xl shadow-lg card-hover border border-slate-100" data-aos="fade-up"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2">Local & Global SEO Expertise</h3>
                            <p class="text-slate-600">
                ...
                <div class="p-6 bg-white rounded-2xl shadow-lg card-hover border border-slate-100" data-aos="fade-up"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2">White-Hat SEO Practices</h3>
                            <p class="text-slate-600">
                ...
                <div class="p-6 bg-white rounded-2xl shadow-lg card-hover border border-slate-100" data-aos="fade-up"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2">Data-Driven Strategies</h3>
                            <p class="text-slate-600">
                ...
                <div class="p-6 bg-white rounded-2xl shadow-lg card-hover border border-slate-100" data-aos="fade-up"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2">Integrated Approach</h3>
                            <p class="text-slate-600">
                ...
                <div class="p-6 bg-white rounded-2xl shadow-lg card-hover border border-slate-100" data-aos="fade-up"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2">Dedicated Account Management</h3>
                            <p class="text-slate-600">
